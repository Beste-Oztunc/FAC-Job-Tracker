...
# The browser application writes output/app_config.json.
# Defaults above remain authoritative when no app configuration exists.
from job_app_runtime import apply_collector_config
...
def main() -> None:
    """
    Run quietly from Terminal, or stream progress to the local app.
    """

    if "--app-progress" in sys.argv:
